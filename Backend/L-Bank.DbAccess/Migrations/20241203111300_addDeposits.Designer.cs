...
namespace L_Bank_W_Backend.DbAccess.Migrations
{
    ...
    [Migration("20241203111300_addDeposits")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("L_Bank.Core.Models.Deposit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("L_Bank.Core.Models.Deposit", b =>
                {
                    b.HasOne("L_Bank_W_Backend.Core.Models.User", "Depositor")
                        .WithMany()
                        .HasForeignKey("DepositorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("L_Bank_W_Backend.Core.Models.Ledger", "Ledger")
                        .WithMany("Deposits")
